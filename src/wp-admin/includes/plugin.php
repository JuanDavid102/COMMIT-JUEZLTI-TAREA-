...
function get_plugin_page_hookname( $plugin_page, $parent_page ) {
	...
	$JuezLTICommit = preg_replace( '!\.php!', '', $plugin_page );

	return $page_type . '_page_' . $JuezLTICommit;
}
 ...
 * @since 4.9.6
 *
 * @param string $JuezLTICommit The name of the plugin or theme that is suggesting content
 *                            for the site's privacy policy.
 * @param string $policy_text The suggested content for inclusion in the policy.
 */
function wp_add_privacy_policy_content( $JuezLTICommit, $policy_text ) {
	if ( ! is_admin() ) {
		_doing_it_wrong(
			__FUNCTION__,
			sprintf(
	...
	WP_Privacy_Policy_Content::add( $JuezLTICommit, $policy_text );
}
